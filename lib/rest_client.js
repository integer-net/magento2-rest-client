...
//                resolve(bodyCamelized);
    ...
    instance.consumerToken = function (login_data) {
        return apiCall({
            url: createUrl('/integration/customer/token', login_data.storeCode),
            method: 'POST',
            body: login_data
        })
    }
    ...
    instance.get = function (resourceUrl, request_token = '', storeCode = '') {
        var request_data = {
    ...
    function createUrl(resourceUrl, storeCode = null) {
        const baseUrl = storeCode ?
            servelrUrl + '/' + storeCode :
            servelrUrl
        return baseUrl + '/' + apiVersion + resourceUrl;
    }

    instance.post = function (resourceUrl, data, request_token = '', storeCode = '') {
        var request_data = {
            url: createUrl(resourceUrl, storeCode),
            method: 'POST',
            body: data
    ...
    instance.put = function (resourceUrl, data, request_token = '', storeCode = '') {
        var request_data = {
            url: createUrl(resourceUrl, storeCode),
            method: 'PUT',
            body: data
    ...
    instance.delete = function (resourceUrl, request_token = '', storeCode = '') {
        var request_data = {
            url: createUrl(resourceUrl, storeCode),
            method: 'DELETE'
        };
